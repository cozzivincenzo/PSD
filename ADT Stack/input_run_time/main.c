...
int main(void){
    ...
    char str[MAX]; // Dichiarazione di una stringa utile a contenere l'espressione in notazione polacca
    ...
    while(flag==0){
        ...
        switch (key){
            ...
            case 3:
                ...
                printf("Inserire l'espressione in notazione polacca:\n");
                fgets(str, 50, stdin);

                conversionePostIn(str); // Chiamata alla funzione utile alla risoluzione dell'espressione in notazione polacca
            break;
            case 0:
